...
const thePlugin = require("../utils/test-transform")(require("../src/index"));
...
describe("hoist-loose-functions-plugin", () => {
  describe("loose mode", () => {
    ...
    thePlugin(
      "should hoist inside function expressions",
      `
      var foo = function () {
        if (true) {
          function bar() {}
  ...
  describe("methods", () => {
    thePlugin(
      "should hoist functions in class methods",
      `
      class Foo {
        bar() {
          if (true) {
    ...
    thePlugin(
      "should hoist functions in object methods",
      `
      const obj = {
        bar() {
          if (true) {
